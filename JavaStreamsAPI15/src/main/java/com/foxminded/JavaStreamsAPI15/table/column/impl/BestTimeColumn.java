...
public class BestTimeColumn implements Column {

	private final String TITLE = "Best Time";
	...
	public String getData(Racer racer) {
		if (racer != null) {
			return RacerUtils.formatDuration(RacerUtils.bestLapTime.apply(racer));
		} else {
			return "";
		}
	}
	...
	public Comparator<Racer> getComparator() {
		...
		return Comparator.comparing(RacerUtils.bestLapTime::apply).reversed();
	}
